...
( function( $ ) {
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if ( 'nxt_section' !== section.params.type || 'undefined' === typeof section.params.section ) {
        return;
      }
    ...
    api.panel.each( function( panel ) {
      ...
      if ( 'nxt_panel' !== panel.params.type || 'undefined' === typeof panel.params.panel ) {
