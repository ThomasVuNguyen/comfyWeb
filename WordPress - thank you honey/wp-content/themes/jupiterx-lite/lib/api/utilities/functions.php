...
if ( ! function_exists( 'jupiterx_wpcolorpickeralpha_localize' ) ) {
	...
	function jupiterx_wpcolorpickeralpha_localize() {
		$color_picker_strings = array(
			'clear'            => __( 'Clear', 'jupiterx-lite' ),
			'clearAriaLabel'   => __( 'Clear color', 'jupiterx-lite' ),
			'defaultString'    => __( 'Default', 'jupiterx-lite' ),
			'defaultAriaLabel' => __( 'Select default color', 'jupiterx-lite' ),
			'pick'             => __( 'Select Color', 'jupiterx-lite' ),
			'defaultLabel'     => __( 'Color value', 'jupiterx-lite' ),
		);
