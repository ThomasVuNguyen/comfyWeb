		...
		<div class="jupiterx-welcome-header">
			<div class="jupiterx-welcome-title">
				<?php
					...
					echo esc_html( sprintf( __( 'Welcome to Jupiter X v%s', 'jupiterx-lite' ), JUPITERX_VERSION ) );
				?>
			</div>
			<div class="jupiterx-welcome-desc">
				<?php esc_html_e( 'Thanks for installing Jupiter X WordPress theme! Jupiter X is a fast, light and powerful WordPress theme for building all kinds of websites. Everything in your website, from header and footer to your custom post types and woo-commerce store, is now customizable thanks to Jupiter X.', 'jupiterx-lite' ); ?>
			</div>
		</div>
		<div class="jupiterx-welcome-rplugins">
			<div class="jupiterx-welcome-rplugins-title">
				<?php esc_html_e( 'To complete the installation and unlock all Jupiter X features, install and activate these plugins:', 'jupiterx-lite' ); ?>
			</div>
			...
			<div class="jupiterx-welcome-rplugins-error">
				<div role="alert"><?php esc_html_e( 'Could not connect to Artbees server, please try again and if the issue persists contact support', 'jupiterx-lite' ); ?></div>
			</div>
			...
			<div class="jupiterx-welcome-rplugins-action">
				<button class="jupiterx-welcome-rplugins-action-btn">
					...
					<span><?php esc_html_e( 'Install and activate all required plugins', 'jupiterx-lite' ); ?></span>
				</button>
			</div>
		</div>
		<div class="jupiterx-welcome-video" style="display: none;">
			<div class="jupiterx-welcome-video-title">
				<?php esc_html_e( 'Watch this quick walk-through video to get started:', 'jupiterx-lite' ); ?>
			</div>
