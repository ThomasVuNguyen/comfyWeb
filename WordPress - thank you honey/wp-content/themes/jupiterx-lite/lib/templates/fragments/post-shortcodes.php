...
function jupiterx_post_social_share_shortcode( $markup_key, $filtered_social = [], $name_enabled = true ) {
	...
	$social_networks = [
		...
		'whatsapp'   => [
			'label'  => esc_attr__( 'Share on Whatsapp', 'jupiterx-lite' ),
			'name'   => esc_html__( 'Whatsapp', 'jupiterx-lite' ),
			'url'    => 'https://api.whatsapp.com/send?text=%1$s',
			'icon'   => 'whatsapp',
		],
		'telegram'   => [
			'label'  => esc_attr__( 'Share on Telegram', 'jupiterx-lite' ),
			'name'   => esc_html__( 'Telegram', 'jupiterx-lite' ),
			'url'    => 'https://t.me/share/url?url=%1$s',
			'icon'   => 'telegram-paper-plane',
		],
		'vk'   => [
			'label'  => esc_attr__( 'Share on VK', 'jupiterx-lite' ),
			'name'   => esc_html__( 'VK', 'jupiterx-lite' ),
